  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Profile Info */}
        <h2 className="text-2xl font-bold text-center text-gray-900 mb-4">Your Profile</h2>
        ...
        <div className="mt-6 flex justify-between">
          {editing ? (
            ...
            <button
              ...
              className="bg-blue-500 hover:bg-pink-800 text-white px-4 py-2 rounded-md cursor-pointer"
            >
              Edit Profile
            </button>
          )}
          <button
            ...
            className="bg-red-500 hover:bg-pink-800 text-white px-4 py-2 rounded-md cursor-pointer"
          >
            Logout
          </button>
        </div>
      ...
      {suggestedNews.length > 0 && (
        <div className="mt-10 w-full max-w-4xl bg-black-900 bg-opacity-90 rounded-xl p-6 shadow-lg">
